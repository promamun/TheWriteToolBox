                                    ...
                                    <div className="swiper-wrapper">
                                        <div className="swiper-slide">
                                            <div className="row">
                                                ...
                                                <div className="row">
                                                    <div
                                                        className="col-lg-7 col-md-9 col-12 order-2 order-md-1"
                                                    >
                                                            ...
                                                            <div className="col-6">
                                                                <ul className="list-unstyled mb-0">
                                                                    <li className="d-flex mb-4 align-items-center">
                                                                        <p
                                                                            className="mb-0 fw-medium me-2 website-analytics-text-bg"
                                                                        >
                                                                            28%
                                                                        </p>
                                                    ...
                                                    <div
                                                        className="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center"
                                                    >
                                                        <img
                            ...
                            ></span>
                              ...
                              >
                                            ...
                                            <div className="col-4 text-end">
                                                <div
                                                    className="d-flex gap-2 justify-content-end align-items-center mb-2"
                                                >
                          ...
                          <i className="ti ti-credit-card ti-sm"></i>
                            ...
                            <div className="col-lg-6 mb-4">
                                <div className="card h-100">
                                    <div
                                        className="card-header pb-0 d-flex justify-content-between mb-lg-n4"
                                    >
                                    ...
                                    <div className="card-body">
                                        <div className="row">
                                            <div
                                                className="col-12 col-md-4 d-flex flex-column align-self-end"
                                            >
                                                <div
                                                    className="d-flex gap-2 align-items-center mb-2 pb-1 flex-wrap"
                                                >
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="card h-100">
                                    <div
                                        className="card-header d-flex justify-content-between pb-0"
                                    >
                                        <div className="card-title mb-0">
                                        ...
                                        <div className="row">
                                            <div className="col-12 col-sm-4 col-md-12 col-lg-4">
                                                ...
                                                <ul className="p-0 m-0">
                                                    <li
                                                        className="d-flex gap-3 align-items-center mb-lg-3 pt-2 pb-1"
                                                    >
                                                        <div className="badge rounded bg-label-primary p-1">
                                                    ...
                                                    <li
                                                        className="d-flex gap-3 align-items-center mb-lg-3 pb-1"
                                                    >
                                                        <div className="badge rounded bg-label-info p-1">
                                        ...
                                        <ul className="p-0 m-0">
                                            <li className="d-flex align-items-center mb-4">
                                                ...
                                                >
                                                    ...
                                                    <div className="user-progress">
                                                        <p
                                                            className="text-success fw-medium mb-0 d-flex justify-content-center gap-1"
                                                        >
                                            ...
                                            <li className="d-flex align-items-center mb-4">
                                                ...
                                                >
                                                    ...
                                                    <div className="user-progress">
                                                        <p
                                                            className="text-danger fw-medium mb-0 d-flex justify-content-center gap-1"
                                                        >
                                            ...
                                            <li className="d-flex align-items-center mb-4">
                                                ...
                                                >
                                                    ...
                                                    <div className="user-progress">
                                                        <p
                                                            className="text-success fw-medium mb-0 d-flex align-items-center gap-1"
                                                        >
                                                            <i className="ti ti-chevron-up"></i>
                                                            12.4%
                                                        </p>
                            ...
                            <div className="col-12 col-xl-4 mb-4 col-md-6">
                                <div className="card">
                                    <div
                                        className="card-header d-flex justify-content-between pb-1"
                                    >
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex align-items-start my-4">
                                            <div
                                                className="badge rounded bg-label-primary p-2 me-3 rounded"
                                            >
                                                <i className="ti ti-currency-dollar ti-sm"></i>
                                            </div>
                                            <div
                                                className="d-flex justify-content-between w-100 gap-2 align-items-center"
                                            >
                                                <div className="me-2">
                                        ...
                                        <div className="d-flex align-items-start">
                                            <div
                                                className="badge rounded bg-label-secondary p-2 me-3 rounded"
                                            >
                                                <i className="ti ti-brand-paypal ti-sm"></i>
                                            </div>
                                            <div
                            ...
                            <div className="col-xl-4 col-md-6 mb-4">
                                <div className="card h-100">
                                    ...
                                    <div className="card-body">
                                        <ul className="p-0 m-0">
                                            <li
                                                className="mb-4 pb-1 d-flex justify-content-between align-items-center"
                                            >
                                    ...
                                    <div className="card-body">
                                        <ul className="list-unstyled mb-0">
                                            <li className="mb-3 pb-1">
                                                <div className="d-flex align-items-start">
                                                    <div
                                                        className="badge bg-label-secondary p-2 me-3 rounded"
                                                    >
                                                        <i className="ti ti-shadow ti-sm"></i>
                                                    </div>
                                                    <div
                                                        className="d-flex justify-content-between w-100 flex-wrap gap-2"
                                                    >
                                                        <div className="me-2">
                            ...
                            {/*// <!-- Projects table -->*/}
                            <div
                                className="col-12 col-xl-8 col-sm-12 order-1 order-lg-2 mb-4 mb-lg-0"
                            >
                                <div className="card">

                        ...
                        <div className="row g-5 mb--60">
                            <div className="col-lg-6 col-md-6 col-12">
                                <div className="section-title text-start">
                                    <span className="subtitle bg-secondary-opacity">COURSE PRICING</span>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-12">
                                <div className="pricing-billing-duration text-start text-md-end">
                                    <ul>
                                        <li className="nav-item">
                                            <button className="nav-link yearly-plan-btn" type="button">Yearly Plan
                                            </button>
                                        </li>
                                        <li className="nav-item">
                                            <button className="nav-link monthly-plan-btn active" type="button">Monthly
                                                Plan
                                            </button>
                                        </li>
                                    </ul>
                        ...
                        <div className="row g-5">
                                ...
                                <div className="pricing-table style-2">
                                    ...
                                    <div className="pricing-body">
                                        <ul className="list-item">
                                            <li><i className="feather-check"/> Unlimited Access Courses</li>
                                            <li><i className="feather-check"/> Certificate After Completion</li>
                                            <li className="off"><i className="feather-x"/> 24/7 Dedicated Support
                                            </li>
                                            <li className="off"><i className="feather-x"/> Unlimited Emails</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6 col-12">
                                <div className="pricing-table style-2 active">
                                    <div className="pricing-header">
                                        <div className="pricing-badge"><span>Popular</span></div>
                                    ...
                                    <div className="pricing-body">
                                        <ul className="list-item">
                                            <li><i className="feather-check"/> Unlimited Access Courses</li>
                                            <li><i className="feather-check"/> Certificate After Completion</li>
                                            <li><i className="feather-check"/> High Resolution Videos</li>
                                            <li><i className="feather-check"/> 24/7 Dedicated Support</li>
                                        </ul>
                                    </div>

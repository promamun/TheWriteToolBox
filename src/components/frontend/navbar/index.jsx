  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (bodyHasStickyHeader) {
        ...
        const topHeaderH =
          document.querySelector(".rbt-header-top")?.offsetHeight || 0;
              ...
              <ul className="quick-access">
                <li className="access-icon rbt-mini-cart">
                  ...
                  >
                    ...
                    <span className="rbt-cart-count">{totalCartItem}</span>
                  </Link>
                </li>

                            ...
                            <div className="col-md-12 pb--120 pt--70">
                                <div className="content">
                                    <div className="inner">
                                        ...
                                        <h1 className="title">We Help You Write<br/>
                                            <span className="header-caption">
                                                    <span className="cd-headline clip is-full-width">
                                                        <span className="cd-words-wrapper">
                                                            <b className="is-visible theme-gradient">Blogs.</b>
                                                            <b className="is-hidden theme-gradient">Books.</b>
                                                            <b className="is-hidden theme-gradient">Articles.</b>
                                                            <b className="is-hidden theme-gradient">Guest Blog Posts.</b>
                                                            <b className="is-hidden theme-gradient">Website Contents.</b>
                                                            <b className="is-hidden theme-gradient">Email Campaigns.</b>
                                                            <b className="is-hidden theme-gradient">Social Media Posts.</b>
                                                        </span>
                                                </span>
                                            </span>
                                        </h1>
                                        <p className="description">
                                            Increasing Confidence, Clarity & Publicity for Self-Made Industry Leaders
                                            and Influencers Who Want to Uplevel Their Expert Status Through Real,
                                ...
                                <span className="btn-icon"><i className="feather-arrow-right"/></span>
                                    ...
                                    <div className="shape-wrapper" id="scene">
                                        <img src="assets/image/the-write-toolbox.png"
                                             alt="Hero Image"/>
                                    ...
                                    <div
                                        className="banner-card pb--60 mb--50 swiper mySwiper rbt-dot-bottom-center banner-swiper-active">
                                                ...
                                                <div className="rbt-card variation-01 rbt-hover">
                                                    ...
                                                    <div className="rbt-card-body">
                                                        <ul className="rbt-meta">
                                                            <li><i className="feather-book"/>12 Lessons</li>
                                                            <li><i className="feather-users"/>50 Students</li>
                                                        </ul>

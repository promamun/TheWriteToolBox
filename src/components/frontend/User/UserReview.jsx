                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span className="b3">
                            Course:{" "}
                            <Link to="#">Speaking Korean for Beginners</Link>
                          </span>
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="b3">
                            Course: <Link to="#">PHP for Beginners</Link>
                          </span>
                          <div className="rbt-review">
                            <div className="rating">
                              <i className="fas fa-star" />
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="b3">
                            Course: <Link to="#">WordPress for Beginners</Link>
                          </span>
                          <div className="rbt-review">
                            <div className="rating">
                              <i className="fas fa-star" />
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="b3">
                            Course: <Link to="#">Design for Beginners</Link>
                          </span>
                          <div className="rbt-review">
                            <div className="rating">
                              <i className="fas fa-star" />
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="rbt-button-group">
                            <Link className="rbt-btn-link left-icon" to="#">

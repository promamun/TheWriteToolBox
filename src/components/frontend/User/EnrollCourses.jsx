            ...
            <div className="rbt-dashboard-content bg-color-white rbt-shadow-box">
                <div className="content">
                    ...
                    <div className="advance-tab-button mb--30">
                        <ul className="nav nav-tabs tab-button-style-2 justify-content-start" id="myTab-4"
                            role="tablist">
                            <li role="presentation">
                                <Link href="#" className="tab-button active" id="home-tab-4" data-bs-toggle="tab"
                                   data-bs-target="#home-4" role="tab" aria-controls="home-4" aria-selected="true">
                                    <span className="title">Enrolled Courses</span>
                                </Link>
                            </li>
                            <li role="presentation">
                                <Link href="#" className="tab-button" id="profile-tab-4" data-bs-toggle="tab"
                            ...
                            <li role="presentation">
                                <Link href="#" className="tab-button" id="contact-tab-4" data-bs-toggle="tab"
                    ...
                    <div className="tab-content">
                        <div className="tab-pane fade active show" id="home-4" role="tabpanel"
                                        ...
                                        <div className="rbt-card-body">
                                            <div className="rbt-card-top">
                                                ...
                                                <div className="rbt-bookmark-btn">
                                                    <Link className="rbt-round-btn" title="Bookmark" href="#"><i
                                                        className="feather-bookmark"/></Link>
                                                </div>
                                            </div>
                                            <h4 className="rbt-card-title"><Link href="/course-details">React
                                                Front To Back</Link>
                                            </h4>
                                            ...
                                            <div className="rbt-progress-style-1 mb--20 mt--10">
                                                <div className="single-progress">
                                                    ...
                                                    <div className="progress">
                                                        <div className="progress-bar wow fadeInLeft bar-color-success"
                                            ...
                                            <div className="rbt-card-bottom">
                                                <Link className="rbt-btn btn-sm bg-primary-opacity w-100 text-center"
                                                   href="#">Download Certificate</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div className="rbt-card-body">
                                            ...
                                            <h4 className="rbt-card-title"><Link to="/course-details">PHP
                                                Beginner + Advanced</Link>
                                            </h4>
                                            <ul className="rbt-meta">
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div className="rbt-card-body">
                                            ...
                                            <h4 className="rbt-card-title"><Link to="/course-details">Angular
                                                Zero to
                                                Mastery</Link>
                                            </h4>
                                            <ul className="rbt-meta">
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div className="rbt-card-body">
                                            ...
                                            <h4 className="rbt-card-title"><Link to="/course-details">English
                                                Langiage Club</Link>
                                            </h4>
                                            <ul className="rbt-meta">
                                                <li><i className="feather-book"/>20 Lessons</li>
                                            ...
                                            <div className="rbt-card-bottom">
                                                ...
                                                <Link className="rbt-btn-link" to="/course-details">Learn
                                                    More<i className="feather-arrow-right"/></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div className="rbt-card-body">
                                            ...
                                            <h4 className="rbt-card-title"><Link to="/course-details">Graphic
                                                Courses Club</Link>
                                            </h4>
                                            <ul className="rbt-meta">
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div className="rbt-card-body">
                                            ...
                                            <h4 className="rbt-card-title"><Link to="/course-details">Wed
                                                Design Club</Link>
                                            </h4>
                                            <ul className="rbt-meta">
                                                <li><i className="feather-book"/>20 Lessons</li>

...
const ScrollToTop = () => {
    ...
    return(
      <>
          ...
          {scrollOffset > 50 ? (
              <div className="rbt-progress-parent rbt-backto-top-active" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                  <svg className="rbt-back-circle svg-inner" width="100%" height="100%" viewBox="-1 -1 102 102">
                      <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98"/>
                  </svg>
              </div>
          ) : (
              <div className="rbt-progress-parent" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                  <svg className="rbt-back-circle svg-inner" width="100%" height="100%" viewBox="-1 -1 102 102">
                      <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98"/>
                  </svg>
              </div>
